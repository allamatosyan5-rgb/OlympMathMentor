...
public class AdvTest5Activity extends AppCompatActivity {

    private String[] questions = {
            "1. The solutions to x to the power of n equals 1 are called roots of what?",
            "2. What is the sum of all n-th roots of unity if n > 1?",
            "3. What criterion proves a polynomial cannot be factored over rationals using a prime p?",
            "4. In Eisenstein's criterion, the prime squared must NOT divide the what term?",
            "5. What interpolation method constructs a polynomial passing through specific points?",
            "6. A polynomial of degree n minus 1 is fully determined by how many points?",
            "7. The polynomial with all coefficients equal to 1 is called a what polynomial?",
            "8. If omega is a 3rd root of unity, what is 1 plus omega plus omega squared?",
            "9. Can Eisenstein's criterion prove irreducibility of polynomials directly without substitution sometimes? (yes/no)",
            "10. In Lagrange interpolation, the basis function evaluates to what at its own point?",
            "11. And what does the Lagrange basis function evaluate to at all other given points?",
            "12. If a polynomial has real coefficients and a+bi is a root, what else must be a root? (conjugate)",
            "13. To apply Eisenstein to the cyclotomic polynomial, we substitute x with what? (Type: y+1)",
            "14. Gauss Lemma links irreducibility over integers to irreducibility over what numbers? (rationals)",
            "15. Is it true that a polynomial of degree d can have at most d roots? (yes/no)",
            "16. Are all roots of unity located on a circle of radius 1? (yes/no)",
            "17. The degree of the n-th cyclotomic polynomial equals whose totient function? (Type: Euler)",
            "18. Does the product of all n-th roots of unity always equal 1 or -1? (yes/no)",
            "19. What is the leading coefficient of a polynomial called if it equals exactly 1?",
            "20. Can a polynomial with all integer coefficients have a rational root that is not an integer if it is monic? (yes/no)"
    };

    private String[] correctAnswers = {
            "unity", "0", "eisenstein", "constant", "lagrange", "n", "cyclotomic", "0", "yes", "1",
            "0", "conjugate", "y+1", "rationals", "yes", "yes", "euler", "yes", "monic", "no"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test5);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            // Intent to AdvLesson6Activity when ready
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Irreducibility is tough. Review Eisenstein's criterion and Lagrange.");
            ...
            saveLessonStars(45, 0); // ID 45 = Advanced 5
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Phenomenal! You handled complex roots and irreducibility perfectly.");
            ...
            saveLessonStars(45, earnedStars); // ID 45 = Advanced 5

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson6_unlocked", true).apply();
            prefs.edit().putInt("adv_test5_score", score).apply();
        }
    }
