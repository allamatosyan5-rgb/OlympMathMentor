...
public class Lesson14Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1FormulaTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1FormulaText)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1Example)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec3Test)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 14.");
    }
