...
public class IntTest7Activity extends AppCompatActivity {

    private String[] questions = {
            "1. A takes 10 days to build a wall, B takes 15 days. They work together for 2 days, then A leaves. How many more days will B take to finish?",
            "2. How many liters of a 10% acid solution must be mixed with 5 liters of a 40% acid solution to get a 20% acid solution?",
            "3. A boat goes 24 km upstream in 4 hours, and returns the same distance downstream in 2 hours. What is the speed of the river current (in km/h)?",
            "4. A boy walks at 4 km/h and reaches school 10 minutes late. If he walks at 5 km/h, he is 5 minutes early. What is the distance to the school (in km)?",
            "5. The price of an item increases by 25%. By what percentage must the new price be decreased to return to the original price?",
            "6. A man rows 40 km upstream and 55 km downstream in 13 hours. He can row 30 km upstream and 44 km downstream in 10 hours. What is the speed of the man in still water (in km/h)?",
            "7. Three pipes A, B, and C can fill a tank in 12, 15, and 20 hours respectively. If A is open all the time and B and C are open for one hour each alternately, the tank will be full in how many hours?",
            "8. Two trains, 100m and 120m long, are moving in opposite directions at 40 km/h and 32 km/h. How many seconds will they take to cross each other?",
            "9. In an alloy, the ratio of copper to zinc is 5:3. If 24 kg of the alloy contains exactly x kg of zinc, what is x?",
            "10. A sum of money doubles itself at compound interest in 15 years. In how many years will it become 8 times itself?",
            "11. Working alone, pump A fills a tank in 3 hours, B in 4 hours, and drain C empties it in 6 hours. If all three are opened, how many hours to fill?",
            "12. Fresh fruit contains 68% water, and dry fruit contains 20% water. How much dry fruit (in kg) can be obtained from 100 kg of fresh fruit?",
            "13. A car travels from A to B at 40 km/h and returns at 60 km/h. What is the average speed (in km/h) for the whole journey?",
            "14. If 12 carpenters can make 12 chairs in 12 days, how many chairs can 6 carpenters make in 24 days?",
            "15. A monkey climbs a 60-foot pole. In one minute he climbs 3 feet, and in the next minute he slips 2 feet. How many minutes will it take him to reach the top?"
    };

    private String[] correctAnswers = {
            "10", "10", "3", "5", "20", "8", "7", "11", "9", "45", "2.4", "40", "48", "12", "115"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test7);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest7Activity.this, IntLesson8Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("Complex word problems demand deep analysis. Review the strategies and try again.");
            ...
            tvFeedback.setText("Brilliant! You cracked the advanced word problems.");
            ...
            // Intermediate Lesson 7 identifier is 27
            saveLessonStars(27, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson8_unlocked", true).apply();
            prefs.edit().putInt("int_test7_score", score).apply();
        }
    }
