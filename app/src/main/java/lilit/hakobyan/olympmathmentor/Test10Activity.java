...
public class Test10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(Test10Activity.this, Lesson11Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 6) {
            ...
            saveLessonStars(10, 0); // Պահպանում ենք 0 աստղ
        } else {
            ...
            saveLessonStars(10, earnedStars); // Պահպանում ենք աստղերը
