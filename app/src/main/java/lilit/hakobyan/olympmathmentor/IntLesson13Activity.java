...
public class IntLesson13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_lesson13);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(IntLesson13Activity.this, IntTest13Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Intermediate Lesson 13.");
    }
