...
public class AdvLesson2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson2);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            startActivity(new Intent(AdvLesson2Activity.this, AdvTest2Activity.class));
            finish();
        });
    }
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 2.");
    }
