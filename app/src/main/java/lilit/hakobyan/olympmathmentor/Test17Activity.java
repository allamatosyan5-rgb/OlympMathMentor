...
public class Test17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(Test17Activity.this, Lesson18Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 6) {
            ...
            saveLessonStars(17, 0); // Պահպանում ենք 0 աստղ
        } else {
            ...
            saveLessonStars(17, earnedStars); // Պահպանում ենք աստղերը
