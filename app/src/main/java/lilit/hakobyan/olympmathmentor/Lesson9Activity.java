...
public class Lesson9Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1Bul1)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1Bul2)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1Bul3)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1Bul4)).getText().toString() + ". ");
        ...
        // Խնդիր 3 (The Legendary Hat Paradox)
        ...
        textChunks.add("End of lesson 9.");
    }
