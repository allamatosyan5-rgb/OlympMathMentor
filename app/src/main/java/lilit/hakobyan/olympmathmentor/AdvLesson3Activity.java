...
public class AdvLesson3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson3);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdvLesson3Activity.this, AdvTest3Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 3.");
    }
