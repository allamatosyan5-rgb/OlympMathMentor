...
public class Lesson16Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec2Triples)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec3Conditions)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3Trap)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec4Ratio)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 16.");
    }
