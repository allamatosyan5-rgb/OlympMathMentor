...
public class AdvLesson19Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson19);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            startActivity(new Intent(AdvLesson19Activity.this, AdvTest19Activity.class));
            finish();
        });
    }
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 19.");
    }
