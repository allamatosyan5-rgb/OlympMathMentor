...
public class Lesson3Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1Text2)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvFormulas)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 3.");
    }
