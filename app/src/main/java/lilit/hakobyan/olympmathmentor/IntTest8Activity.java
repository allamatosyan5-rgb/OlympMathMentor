...
public class IntTest8Activity extends AppCompatActivity {

    private String[] questions = {
            "1. Person A says: 'We are both knaves.' What is Person B? (Type: Knight or Knave)",
            "2. Can an 8x8 chessboard with two diagonally opposite corners removed be covered by exactly 31 dominoes? (Yes or No)",
            "3. What is the nim-sum of three piles containing 5, 7, and 9 stones?",
            "4. 100 students pass by 100 lockers. The 1st opens all, 2nd closes even ones, 3rd toggles multiples of 3, etc. How many lockers remain open?",
            "5. You have 3 boxes: Apples, Oranges, and Mixed. All are labeled INCORRECTLY. What is the minimum number of fruits you must pick to label them all correctly?",
            "6. A frog jumps 1, 2, or 3 steps at a time. How many distinct ways can the frog reach step 4?",
            "7. In a knockout tennis tournament with 128 players, how many matches must be played to find the champion?",
            "8. If 5 gears are connected in a line, and the 1st turns clockwise, what direction does the 5th turn? (Type: Clockwise or Counterclockwise)",
            "9. You have 9 coins, one is fake and lighter. What is the minimum number of weighings on a balance scale needed to guarantee finding it?",
            "10. A bacteria doubles its size every minute. It fills a jar in 60 minutes. At what minute is the jar exactly half full?",
            "11. There are 13 red, 15 green, and 17 blue chameleons. When two different colors meet, they change to the third color. Can they all eventually become the same color? (Yes or No)",
            "12. How many times in a 12-hour period do the hour hand and minute hand of a clock perfectly overlap?",
            "13. There are 5 points on a plane, no three of which are collinear. How many distinct straight lines can be drawn connecting them?",
            "14. You have 21 blue, 15 black, and 17 red socks in a drawer. What is the minimum number of socks you must pull out in the dark to guarantee a matching pair?",
            "15. 100 prisoners stand in a circle. Counting starts at prisoner 1, and every 2nd person is executed. What is the original number of the sole survivor? (Josephus Problem)"
    };

    private String[] correctAnswers = {
            "knight", "no", "11", "10", "1", "7", "127", "clockwise", "2", "59", "no", "11", "10", "4", "73"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test8);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest8Activity.this, IntLesson9Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("Logic puzzles require sharp thinking! Review the invariants and game theory rules, then try again.");
            ...
            tvFeedback.setText("Fantastic! Your logical reasoning is truly at an Olympiad level.");
            ...
            // Intermediate Lesson 8 identifier is 28
            saveLessonStars(28, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson9_unlocked", true).apply();
            prefs.edit().putInt("int_test8_score", score).apply();
        }
    }
