...
public class IntLesson10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_lesson10);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(IntLesson10Activity.this, IntTest10Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Intermediate Lesson 10.");
    }
