...
public class IntLesson4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_lesson4);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(IntLesson4Activity.this, IntTest4Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Intermediate Lesson 4.");
    }
