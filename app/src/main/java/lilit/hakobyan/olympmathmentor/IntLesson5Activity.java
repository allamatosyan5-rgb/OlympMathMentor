...
public class IntLesson5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_lesson5);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(IntLesson5Activity.this, IntTest5Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Intermediate Lesson 5.");
    }
