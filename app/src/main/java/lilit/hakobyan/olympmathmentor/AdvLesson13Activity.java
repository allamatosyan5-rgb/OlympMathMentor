...
public class AdvLesson13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson13);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdvLesson13Activity.this, AdvTest13Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 13.");
    }
