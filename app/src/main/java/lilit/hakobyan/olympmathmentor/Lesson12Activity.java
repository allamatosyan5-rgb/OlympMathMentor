...
public class Lesson12Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        // Problem 4
        textChunks.add(((TextView) findViewById(R.id.tvProb4Title)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4Q)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4S1)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4S2)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4S3)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4S4)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4S5)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb4Ans)).getText().toString() + ". ");

        textChunks.add("End of lesson 12.");
    }
