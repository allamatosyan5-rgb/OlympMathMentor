...
public class Lesson2Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvIntro)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvTerms)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvRule)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvVerify)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvFormulaTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvFormulaText)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvExample)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvFormsTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvFormsText)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 2.");
    }
