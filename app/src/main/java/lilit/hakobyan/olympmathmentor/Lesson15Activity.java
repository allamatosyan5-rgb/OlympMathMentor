...
public class Lesson15Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1PrimesTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1PrimesText)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1CompTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1CompText)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1TrapTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1TrapText)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec2Tree)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec2Text2)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec2Equation)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec3RuleTitle)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3RuleText)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3Example)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvProb1S5)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvProb3S5)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvProb3Ans)).getText().toString() + ". ");

        textChunks.add("End of lesson 15.");
    }
