...
public class Lesson17Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1Rule)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec2Trick)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3Title)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3Circum)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec3Incenter)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec4Rule)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 17.");
    }
