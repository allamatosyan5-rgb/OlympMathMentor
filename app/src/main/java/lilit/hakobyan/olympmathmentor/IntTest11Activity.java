...
public class IntTest11Activity extends AppCompatActivity {

    private String[] questions = {
            "1. A right triangle has legs of length 7 and 24. What is the length of the hypotenuse?",
            "2. The interior angles of a triangle are in the ratio 1:4:7. What is the measure of the largest angle (in degrees)?",
            "3. The lengths of two sides of a triangle are 5 and 9. What is the smallest possible integer length of the third side?",
            "4. Two similar triangles have areas of 16 and 81. If a side of the smaller triangle is 12, what is the corresponding side of the larger triangle?",
            "5. What is the sum of the interior angles of a convex decagon (10-sided polygon)?",
            "6. In triangle ABC, AB=AC. If the exterior angle at vertex B is 110°, what is the measure of angle A?",
            "7. The midsegment of a trapezoid is 15. If one base is 10, what is the length of the other base?",
            "8. A rectangle has a diagonal of 13 and a width of 5. What is its area?",
            "9. In a regular polygon, each interior angle is 150°. How many sides does it have?",
            "10. A right triangle has a hypotenuse of 10 and an area of 24. What is its perimeter?",
            "11. The hypotenuse of an isosceles right triangle is 8. What is its area?",
            "12. In triangle ABC, AD bisects angle A. If AB=6, AC=8, and BD=3, what is the length of CD?",
            "13. The sides of a triangle are 13, 14, and 15. What is its area? (Use Heron's Formula)",
            "14. An equilateral triangle has a height of 3√3. What is its perimeter?",
            "15. In a right triangle, the altitude to the hypotenuse divides it into segments of 4 and 9. What is the length of the altitude?"
    };

    private String[] correctAnswers = {
            "25", "105", "5", "27", "1440", "40", "20", "60", "12", "24", "16", "4", "84", "18", "6"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test11);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest11Activity.this, IntLesson12Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("Geometry demands precision. Review the theorems and formulas, then try again.");
            ...
            tvFeedback.setText("Outstanding! You have a great foundation in Olympiad Geometry.");
            ...
            // Intermediate Lesson 11 identifier is 31
            saveLessonStars(31, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson12_unlocked", true).apply();
            prefs.edit().putInt("int_test11_score", score).apply();
        }
    }
