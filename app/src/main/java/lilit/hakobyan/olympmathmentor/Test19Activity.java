...
public class Test19Activity extends AppCompatActivity {
    ...
    private String[] questions = {
            "1. In a cyclic quadrilateral, if Angle A = 80°, what is the measure of the opposite Angle C in degrees?",
            "2. A cyclic quadrilateral has side lengths 3, 4, 5, and 6. Can its Area be calculated by Brahmagupta's formula? (1 for YES, 0 for NO)",
            "3. The diagonals of a cyclic quadrilateral are 5 and 6, and two opposite sides are 3 and 4. What is the product of the other two sides (using Ptolemy)?",
            "4. A regular hexagon has how many diagonals?",
            "5. The sum of interior angles of a regular 10-sided polygon (decagon) is how many degrees?",
            "6. In a cyclic quadrilateral with sides 1, 4, 7, 8, what is the semi-perimeter 's'?",
            "7. If an inscribed angle in a circle is 30°, what is the measure of the central angle standing on the same arc?",
            "8. A regular octagon has one interior angle of how many degrees?",
            "9. If AC=8, BD=10, AB=4, CD=5, and BC=6, find the length of side AD using Ptolemy (AC*BD = AB*CD + BC*AD).",
            "10. Can a non-rectangular rhombus be cyclic? (1 for YES, 0 for NO)"
    };

    private String[] correctAnswers = {
            "100", "1", "18", "9", "1440", "10", "60", "135", "10", "0"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test19); // Համոզվիր, որ ունես այս xml-ը
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            startActivity(new Intent(Test19Activity.this, Lesson20Activity.class));
            finish();
        });
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 6) {
            tvFeedbackResult.setText("Geometry theorems require practice. Try again!");
