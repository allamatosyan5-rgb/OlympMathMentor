...
public class Test9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- NEXT LESSON LOGIC: OPENS LESSON 10 ---
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            try {
                // Try to open Lesson 10 if it exists
                ...
                // Fallback if Lesson 10 isn't created yet
                finish();
            }
        });
    }
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 6) {
            ...
            prefs.edit()
                    .putBoolean("lesson10_unlocked", true) // Unlocks Lesson 10
