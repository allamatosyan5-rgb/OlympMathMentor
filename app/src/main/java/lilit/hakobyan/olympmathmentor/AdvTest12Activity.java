...
public class AdvTest12Activity extends AppCompatActivity {
    ...
    private String[] questions = {
            "1. A number a is a quadratic residue modulo p if x^2 = a mod p has a what? (Type: solution)",
            "2. The symbol used to denote quadratic residues is named after whom? (Type: legendre)",
            "3. The Legendre symbol evaluates to 1, -1, or what? (Type: 0)",
            "4. Euler's Criterion raises 'a' to the power of what? (Type: (p-1)/2)",
            "5. The Law of Quadratic Reciprocity was proven by which Prince of Mathematics? (Type: gauss)",
            "6. The law connects the solvability of x^2=p mod q and x^2=q mod what? (Type: p)",
            "7. The product (p/q)*(q/p) depends on whether the primes are congruent to what mod 4? (Type: 3)",
            "8. If both primes are 3 mod 4, the product of their Legendre symbols is what? (Type: -1)",
            "9. If at least one prime is 1 mod 4, the product is what? (Type: 1)",
            "10. Is 2 a quadratic residue modulo 5? (yes/no)",
            "11. Is -1 a quadratic residue for primes congruent to 1 mod 4? (yes/no)",
            "12. Quadratic residues exhibit a beautiful symmetry known as what? (Type: reciprocity)",
            "13. Diophantine equations can often be proven unsolvable by looking at them modulo what? (Type: prime)",
            "14. For the equation x^2 - 5y^2 = 2, we took the equation modulo what? (Type: 5)",
            "15. What did x^2 congruent to 2 modulo 5 evaluate to in the Legendre symbol? (Type: -1)",
            "16. How many quadratic residues are there modulo an odd prime p (excluding 0)? (Type: (p-1)/2)",
            "17. Does Euler's criterion require p to be an odd prime? (yes/no)",
            "18. If (a/p) = 1, then 'a' is a what? (Type: residue)",
            "19. If (a/p) = -1, then 'a' is a non-what? (Type: residue)",
