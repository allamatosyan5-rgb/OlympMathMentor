...
public class AdvLesson17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson17);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            startActivity(new Intent(AdvLesson17Activity.this, AdvTest17Activity.class));
            finish();
        });
    }
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 17.");
    }
