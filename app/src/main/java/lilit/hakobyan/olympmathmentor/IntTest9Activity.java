...
public class IntTest9Activity extends AppCompatActivity {

    private String[] questions = {
            "1. By the Handshake Lemma, if a graph has 10 edges, what is the sum of the degrees of all its vertices?",
            "2. In a group of 15 people, can each person be friends with exactly 3 other people? (Type: Yes or No)",
            "3. An Eulerian circuit exists in a connected graph only if EVERY vertex has what kind of degree? (Type: Even or Odd)",
            "4. Does the classic 'Seven Bridges of Königsberg' graph have an Eulerian path? (Type: Yes or No)",
            "5. You have 10 pairs of black socks and 10 pairs of white socks in a drawer. What is the minimum number of single socks you must draw blindly to guarantee a matching pair?",
            "6. A school has 400 students. What is the minimum number of students who MUST share the same birthday month?",
            "7. Choose any 5 points in a square of side length 2. What is the maximum distance guaranteed between at least two of these points? (Hint: divide into 4 squares)",
            "8. If you pick 5 distinct integers, at least two of them will have a difference divisible by what number?",
            "9. True or False: Every connected graph with exactly 2 vertices of odd degree has an Eulerian path.",
            "10. In a complete graph of 5 vertices (K5), how many total edges are there?",
            "11. A tree is a connected graph with no cycles. If a tree has 10 vertices, how many edges does it have?",
            "12. What is the Ramsey number R(3,3)? (The minimum party size to guarantee 3 friends or 3 strangers)",
            "13. How many colors are needed to properly color the regions of any planar map so no adjacent regions share a color?",
            "14. If you place 10 pigeons in 3 holes, what is the minimum number of pigeons in the most crowded hole?",
            "15. Can you tile a 10x10 board with 25 straight 1x4 tetrominoes? (Type: Yes or No)"
    };

    private String[] correctAnswers = {
            "20", "no", "even", "no", "3", "34", "1", "4", "true", "10", "9", "6", "4", "4", "no"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test9);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest9Activity.this, IntLesson10Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("Graph Theory can be complex! Review the properties of Eulerian paths and the Pigeonhole principle.");
            ...
            tvFeedback.setText("Amazing logic! You've mastered Advanced Graphs and Pigeonhole proofs.");
            ...
            // Intermediate Lesson 9 identifier is 29
            saveLessonStars(29, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson10_unlocked", true).apply();
            prefs.edit().putInt("int_test9_score", score).apply();
        }
    }
