...
public class AdvTest1Activity extends AppCompatActivity {

    // 20 հարց Advanced Set Theory թեմայով
    private String[] questions = {
            "1. How many subsets does a set with 3 elements have?",
            "2. How many proper subsets does a set with 4 elements have?",
            "3. If A has 4 elements and B has 5 elements, what is the maximum number of elements in A U B?",
            "4. What is the minimum number of elements in A U B from the previous question?",
            "5. If A intersection B is the empty set, the sets A and B are called what? (Type the word)",
            "6. The set of all subsets of A is called the _____ set of A.",
            "7. If |A| = 10, |B| = 15, and |A ∩ B| = 3, what is |A U B|?",
            "8. What is the cardinality of the empty set?",
            "9. De Morgan's Law states that the complement of (A U B) is the intersection of their ____.",
            "10. If A is a subset of B, then A ∩ B equals which set? (Type A or B)",
            "11. If A is a subset of B, then A U B equals which set? (Type A or B)",
            "12. Symmetric difference of A and B is (A \\ B) U ( ? \\ A). (Type the set)",
            "13. If |A| = 7 and |B| = 7 and A=B, what is the cardinality of A \\ B?",
            "14. In PIE for 3 sets, do we 'add' or 'subtract' the intersection of all 3 sets at the end?",
            "15. If the universal set has 20 elements and A has 12, how many elements are in the complement of A?",
            "16. Is the operation of set union commutative? (yes/no)",
            "17. Is the operation of set difference commutative? (yes/no)",
            "18. What single letter represents the set of all Natural numbers?",
            "19. If A has 2 elements and B has 2 elements, how many elements are in the Cartesian product A x B?",
            "20. Does A \\ (B U C) equal (A \\ B) ∩ (A \\ C)? (yes/no)"
    };

    private String[] correctAnswers = {
            "8", "15", "9", "5", "disjoint", "power", "22", "0", "complements", "A",
            "B", "B", "0", "add", "8", "yes", "no", "N", "4", "yes"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test1);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(AdvTest1Activity.this, AdvLesson2Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        // ՆՈՐ ԳՆԱՀԱՏՄԱՆ ՀԱՄԱԿԱՐԳԸ (15-16=1*, 17-19=2*, 20=3*)
        if (score < 15) {
            tvFeedback.setText("Advanced Olympiad topics require perfection. Review the theory and try again.");
            ...
            saveLessonStars(41, 0); // ID 41 համարվում է Advanced 1
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Excellent! You survived the first Advanced test.");
            ...
            saveLessonStars(41, earnedStars); // ID 41 = Advanced 1

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson2_unlocked", true).apply();
            prefs.edit().putInt("adv_test1_score", score).apply();
        }
    }
