...
public class IntTest14Activity extends AppCompatActivity {

    private String[] questions = {
            "1. Varignon's theorem connects the midpoints of any quadrilateral to form what shape?",
            "2. What fraction of the original quadrilateral's area is the Varignon parallelogram? (Type: half, third, or quarter)",
            "3. The line containing the feet of perpendiculars from a point on the circumcircle to the sides is called the ____ Line.",
            "4. For a point INSIDE the circumcircle, the feet of the perpendiculars form a triangle called the ___ triangle.",
            "5. The intersection of the three symmedians is called the ___ point.",
            "6. Miquel's theorem states that three specific circles intersect at exactly one ____.",
            "7. A reflection of a median across the angle bisector of the same vertex is called a ____.",
            "8. The line connecting the midpoints of the diagonals of a quadrilateral is called the ____ Line.",
            "9. The Simson line of a point P bisects the segment from P to the ____ of the triangle.",
            "10. If the diagonals of a quadrilateral are perpendicular, its Varignon parallelogram is a ____.",
            "11. If the diagonals of a quadrilateral are equal in length, its Varignon parallelogram is a ____.",
            "12. What famous theorem relates the diagonals and sides of a cyclic quad: AB*CD + BC*AD = AC*BD?",
            "13. The orthocenter, circumcenter, and centroid always lie on the ____ Line.",
            "14. What shape is formed by the midpoints of an isosceles trapezoid?",
            "15. The Gergonne point is the intersection of lines connecting vertices to the points of tangency of the ____."
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test14);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest14Activity.this, IntLesson15Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("These are elite geometry concepts. Review Simson, Miquel, and Varignon theorems, then try again.");
            ...
            tvFeedback.setText("Phenomenal! Your geometry skills are truly at the Olympiad level.");
            ...
            // Intermediate Lesson 14 identifier is 34
            saveLessonStars(34, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson15_unlocked", true).apply();
            prefs.edit().putInt("int_test14_score", score).apply();
        }
    }
