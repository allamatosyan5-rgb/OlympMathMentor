...
public class AdvLesson16Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson16);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            startActivity(new Intent(AdvLesson16Activity.this, AdvTest16Activity.class));
            finish();
        });
    }
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 16.");
    }
