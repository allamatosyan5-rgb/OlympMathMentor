...
public class Lesson11Activity extends AppCompatActivity {
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec1Rules1)).getText().toString() + ". ");
        textChunks.add(((TextView) findViewById(R.id.tvSec1Rules2)).getText().toString() + ". ");
        ...
        textChunks.add(((TextView) findViewById(R.id.tvSec2Rules)).getText().toString() + ". ");
        ...
        textChunks.add("End of lesson 11.");
    }
