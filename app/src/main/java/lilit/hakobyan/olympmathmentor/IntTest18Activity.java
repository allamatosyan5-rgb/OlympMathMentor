...
public class IntTest18Activity extends AppCompatActivity {

    private String[] questions = {
            "1. A mathematical proposition must be strictly True or strictly ____.",
            "2. What is the logical name for the 'AND' connective? (Type: conjunction or disjunction)",
            "3. What is the logical name for the 'OR' connective? (Type: conjunction or disjunction)",
            "4. If P implies Q, the statement 'NOT Q implies NOT P' is called the ____.",
            "5. True or False: The converse of a true implication (If P then Q) is ALWAYS mathematically true.",
            "6. The symbol ∀ stands for 'For ____'.",
            "7. The symbol ∃ stands for 'There ____'.",
            "8. By De Morgan's Law, the negation of (A AND B) is equivalent to (NOT A) ___ (NOT B).",
            "9. If P is False and Q is True, is the statement (P OR Q) True or False?",
            "10. If P is True and Q is False, is the statement (P AND Q) True or False?",
            "11. In an implication P → Q, the P is the hypothesis, and the Q is the ____.",
            "12. To prove 'If A then B' by contradiction, we must assume A is true and B is ____.",
            "13. If an implication and its converse are BOTH true, we connect them with 'if and ____ if'.",
            "14. A statement that is ALWAYS true regardless of its variables is called a ____.",
            "15. The negation of 'For all x, P(x)' is 'There exists an x such that ____ P(x)'."
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test18);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest18Activity.this, IntLesson19Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("Logic requires strict rules. Review the Truth Tables and De Morgan's laws, then try again.");
            ...
            tvFeedback.setText("Excellent! You've mastered Mathematical Statements.");
            ...
            // Intermediate Lesson 18 identifier is 38
            saveLessonStars(38, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson19_unlocked", true).apply();
            prefs.edit().putInt("int_test18_score", score).apply();
        }
    }
