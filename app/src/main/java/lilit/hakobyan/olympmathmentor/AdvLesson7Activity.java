...
public class AdvLesson7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson7);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdvLesson7Activity.this, AdvTest7Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 7.");
    }
