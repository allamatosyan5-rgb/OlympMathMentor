...
public class AdvTest9Activity extends AppCompatActivity {

    private String[] questions = {
            "1. In geometric inversion, what is the geometric shape of the mirror? (Type: circle)",
            "2. If OP * OP' = R^2, what is point P' called? (Type: inverse)",
            "3. What is the inverse of the center of inversion? (Type: infinity)",
            "4. A line passing through the center of inversion maps to what? (Type: line)",
            "5. A line NOT passing through the center maps to a what? (Type: circle)",
            "6. A circle passing through the center maps to a what? (Type: line)",
            "7. A circle NOT passing through the center maps to a what? (Type: circle)",
            "8. Does geometric inversion preserve the angles between intersecting curves? (yes/no)",
            "9. A transformation that preserves angles is called what? (Type: conformal)",
            "10. Points exactly on the circle of inversion are called what points? (Type: fixed)",
            "11. What theorem links the sides and diagonals of a cyclic quadrilateral?",
            "12. Is the inverse of the inverse of a point the original point? (yes/no)",
            "13. Does an involution mean applying the function twice gives the original input? (yes/no)",
            "14. If a point is outside the circle of inversion, its inverse is located where? (Type: inside)",
            "15. Ptolemy's theorem states AB*CD + BC*AD equals the product of what? (Type: diagonals)",
            "16. Ptolemy's inequality becomes an equality ONLY if the points are what? (Type: cyclic)",
            "17. Can Ptolemy's Theorem be proven simply by applying inversion? (yes/no)",
            "18. Does inversion preserve the radius of a circle generally? (no)",
            "19. What do we call a circle that intersects the circle of inversion at 90 degrees? (Type: orthogonal)",
            "20. An orthogonal circle maps to what under inversion? (Type: itself)"
    };

    private String[] correctAnswers = {
            "circle", "inverse", "infinity", "line", "circle", "line", "circle", "yes", "conformal", "fixed",
            "ptolemy", "yes", "yes", "inside", "diagonals", "cyclic", "yes", "no", "orthogonal", "itself"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test9);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(AdvTest9Activity.this, AdvLesson10Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Geometry can be tricky! Review the properties of Inversion and try again.");
            ...
            saveLessonStars(49, 0); // ID 49 = Advanced 9
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Outstanding! You have mastered Geometric Inversion!");
            ...
            saveLessonStars(49, earnedStars); // ID 49 = Advanced 9

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson10_unlocked", true).apply();
            prefs.edit().putInt("adv_test9_score", score).apply();
        }
    }
