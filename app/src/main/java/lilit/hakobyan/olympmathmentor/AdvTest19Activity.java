...
public class AdvTest19Activity extends AppCompatActivity {
    ...
    private String[] correctAnswers = {
            "polar", "r*e^(it)", "e^(it)", "yes", "a-bi", "modulus", "modulus", "true", "yes", "true",
            "yes", "yes", "-1", "0", "1", "yes", "yes", "yes", "yes", "yes"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test19);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Toast.makeText(this, "Final Lesson Coming Soon!", Toast.LENGTH_SHORT).show();
            // Intent intent = new Intent(AdvTest19Activity.this, AdvLesson20Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Complex numbers are a geometric superpower. Review the rotation formula and try again!");
            ...
            saveLessonStars(59, 0); // ID 59 = Advanced 19
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Outstanding! You've mastered Complex Geometry and unlocked the Final Lesson!");
            ...
            saveLessonStars(59, earnedStars); // ID 59 = Advanced 19

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson20_unlocked", true).apply();
            prefs.edit().putInt("adv_test19_score", score).apply();
        }
    }
