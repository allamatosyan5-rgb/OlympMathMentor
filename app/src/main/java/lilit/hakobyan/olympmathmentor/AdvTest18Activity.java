...
public class AdvTest18Activity extends AppCompatActivity {
    ...
    private String[] correctAnswers = {
            "2", "principle", "yes", "combinatorics", "negation", "yes", "yes", "yes", "yes", "yes",
            "yes", "dirichlet", "yes", "yes", "yes", "no", "no", "no", "yes", "yes"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test18);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(AdvTest18Activity.this, AdvLesson19Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Dirichlet's Principle is powerful. Review the pigeonhole logic and try again!");
            ...
            saveLessonStars(58, 0); // ID 58 = Advanced 18
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Outstanding! You've mastered the Pigeonhole Principle and unlocked Lesson 19!");
            ...
            saveLessonStars(58, earnedStars); // ID 58 = Advanced 18

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson19_unlocked", true).apply();
            prefs.edit().putInt("adv_test18_score", score).apply();
        }
    }
