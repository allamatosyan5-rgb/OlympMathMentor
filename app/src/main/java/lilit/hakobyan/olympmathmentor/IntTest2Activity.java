...
public class IntTest2Activity extends AppCompatActivity {

    private String[] questions = {
            "1. What is the Greatest Common Divisor (GCD) of 1071 and 462?",
            "2. Find the Least Common Multiple (LCM) of 120 and 45.",
            "3. What is the smallest positive integer divisible by 12, 15, and 18?",
            "4. How many trailing zeros are at the end of the number 20! (20 factorial)?",
            "5. The product of any 4 consecutive integers is ALWAYS divisible by what maximum integer?",
            "6. What is the highest power of 2 that completely divides 100! ?",
            "7. Is the expression n^3 - n always divisible by 6 for any integer n? (Yes or No)",
            "8. How many total positive divisors does the number 360 have?",
            "9. Find the exponent 'n' such that GCD(2^100 - 1, 2^120 - 1) = 2^n - 1.",
            "10. Find the smallest positive integer n such that n! is a multiple of 1000.",
            "11. If a and b are integers such that 5a + 3b is divisible by 7, which of these is also divisible by 7: '10a + 6b' or 'a + b'? (Type the exact expression)",
            "12. What is the units digit (last digit) of the number 3^2026?",
            "13. Find the smallest positive integer x that satisfies the Diophantine equation 5x - 3y = 1, where y is also a positive integer.",
            "14. If a number leaves a remainder of 2 when divided by 5, and a remainder of 3 when divided by 4, what is the smallest positive number it could be?",
            "15. What is the remainder when 10^10 is divided by 9?"
    };

    private String[] correctAnswers = {
            "21", "360", "180", "4", "24", "97", "Yes", "24", "20", "15", "10a + 6b", "9", "2", "7", "1"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_test2);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            Intent intent = new Intent(IntTest2Activity.this, IntLesson3Activity.class);
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 10) {
            tvFeedback.setText("This is an advanced topic. Review the lesson and try again to get at least 10 points!");
            ...
            tvFeedback.setText("Outstanding! You passed the Advanced Integers Test.");
            ...
            // Նկատի ունեցիր, որ IntLesson-ների աստղերը պահելու համար կարող ես հատուկ բանալի օգտագործել
            saveLessonStars(22, earnedStars); // Օգտագործում ենք 22 որպես Intermediate 2-ի իդենտիֆիկատոր

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("int_lesson3_unlocked", true).apply();
            prefs.edit().putInt("int_test2_score", score).apply();
        }
    }
