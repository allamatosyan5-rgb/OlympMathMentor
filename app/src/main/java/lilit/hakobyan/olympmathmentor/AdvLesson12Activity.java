...
public class AdvLesson12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson12);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdvLesson12Activity.this, AdvTest12Activity.class);
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 12.");
    }
