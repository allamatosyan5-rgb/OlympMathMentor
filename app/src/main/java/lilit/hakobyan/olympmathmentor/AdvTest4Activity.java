...
public class AdvTest4Activity extends AppCompatActivity {

    private String[] questions = {
            "1. If a polynomial P is divided by (x - a), the remainder is equal to P of what? (Type the variable)",
            "2. If P(a) = 0, then (x - a) is a what of the polynomial?",
            "3. For a quadratic x^2 + bx + c = 0, what is the sum of its roots?",
            "4. What theorem connects the roots of a polynomial to its coefficients?",
            "5. If P has integer coefficients, (a - b) must divide P(a) minus what?",
            "6. What is the product of the roots for x^2 - 7x + 10 = 0?",
            "7. For a cubic x^3 + bx^2 + cx + d = 0, what is the product of its three roots?",
            "8. Can a polynomial of degree n have more than n distinct roots? (yes/no)",
            "9. By Rational Root Theorem, the numerator of a root divides the what term?",
            "10. The denominator of a rational root divides the what coefficient?",
            "11. Can a polynomial of degree 3 have no real roots? (yes/no)",
            "12. If a + bi is a root, what is also a root for polynomials with real coefficients?",
            "13. What is the maximum number of real roots for a polynomial of degree 5?",
            "14. If P(x) = x^3 - 1, what is the value of P(1)?",
            "15. Two polynomials of degree n are identical if they agree on at least n plus what points?",
            "16. The sum of the squares of roots can be found using what mathematician's sums?",
            "17. Does a polynomial of odd degree always cross the x-axis? (yes/no)",
            "18. The Fundamental Theorem of what states every non-constant complex polynomial has a root?",
            "19. If P(2)=5 and P(3)=5, then P(x)-5 is divisible by (x-2) times what?",
            "20. In Vieta's formulas, do the signs of the coefficients alternate? (yes/no)"
    };

    private String[] correctAnswers = {
            "a", "factor", "-b", "vieta", "p(b)", "10", "-d", "no", "constant", "leading",
            "no", "conjugate", "5", "0", "1", "newton", "yes", "algebra", "x-3", "yes"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_test4);
        ...
        findViewById(R.id.btnNextLesson).setOnClickListener(v -> {
            // Intent to AdvLesson5Activity when ready
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Polynomials can be tricky. Review Vieta's formulas and try again.");
            ...
            saveLessonStars(44, 0); // ID 44 = Advanced 4
            try { MediaPlayer.create(this, R.raw.sad).start(); } catch(Exception e){}
        } else {
            tvFeedback.setText("Outstanding! You have mastered advanced polynomial theory.");
            ...
            saveLessonStars(44, earnedStars); // ID 44 = Advanced 4

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_lesson5_unlocked", true).apply();
            prefs.edit().putInt("adv_test4_score", score).apply();
        }
    }
