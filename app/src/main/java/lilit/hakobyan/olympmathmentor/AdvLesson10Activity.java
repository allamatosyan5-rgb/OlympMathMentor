...
public class AdvLesson10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_lesson10);
        ...
        btnStartTest.setOnClickListener(v -> {
            ...
            startActivity(new Intent(AdvLesson10Activity.this, AdvTest10Activity.class));
            finish();
        });
    }
    ...
    private void prepareTextChunks() {
        ...
        textChunks.add("End of Advanced Lesson 10.");
    }
