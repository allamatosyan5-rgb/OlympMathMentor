...
public class AdvTest20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnFinalExam).setOnClickListener(v -> {
            Intent intent = new Intent(AdvTest20Activity.this, AdvFinalExamActivity.class);
    ...
    private void checkResults() {
        ...
        for (int i = 0; i < questions.length; i++) {
            ...
            } else if (userAnswer.contains(correctAnswer) || userAnswer.equals(correctAnswer)) {
                score++;
    ...
    private void showFinalResult(int score) {
        ...
        if (score < 15) {
            tvFeedback.setText("Combinatorics needs practice! Review the lesson and try again.");
            ...
            tvFeedback.setText("Incredible! You have completed the ENTIRE Advanced Level. The Grand Final Exam awaits!");
            ...
            // Advanced Lesson 20 = 60th lesson overall in tracking
            saveLessonStars(60, earnedStars);

            SharedPreferences prefs = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            prefs.edit().putBoolean("adv_final_exam_unlocked", true).apply();
            prefs.edit().putInt("adv_test20_score", score).apply();
        }
    }
